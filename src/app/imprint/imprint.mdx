...
Dessen Kontaktdaten können Sie dem Abschnitt „Impressum“ entnehmen.
...
Die personenbezogenen Daten, die auf dieser Website erfasst werden, werden auf den Servern des Hosters / der Hoster gespeichert.
